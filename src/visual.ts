...
import {kpiClimberChart, initialState} from "./kpiClimberChart/component";
...
export class Visual implements IVisual {
    ...
    constructor(options: VisualConstructorOptions) {
        this.reactRoot = React.createElement(kpiClimberChart, {});
    ...
    private clear() {
        kpiClimberChart.update(initialState);
    }
}